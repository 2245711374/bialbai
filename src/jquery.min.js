  ...
  f.extend({
    ...
    (f.support = (function () {
      ...
      !q.addEventListener &&
        ...
        k.appendChild(q),
        (q.innerHTML = ''),
        a.getComputedStyle && ((j = c.createElement('div')), (j.style.width = '0'), (j.style.marginRight = '0'), (q.style.width = '2px'), q.appendChild(j), (b.reliableMarginRight = (parseInt((a.getComputedStyle(j, null) || { marginRight: 0 }).marginRight, 10) || 0) === 0))
      ...
      k.removeChild(q),
        ...
        f(function () {
          ...
          !r ||
            ...
            typeof q.style.zoom != 'undefined' && ((q.style.display = 'inline'), (q.style.zoom = 1), (b.inlineBlockNeedsLayout = q.offsetWidth === 2), (q.style.display = ''), (q.innerHTML = "<div style='width:4px;'></div>"), (b.shrinkWrapBlocks = q.offsetWidth !== 2)),
            (q.style.cssText = k + m),
            (q.innerHTML = o),
            (d = q.firstChild),
            (e = d.firstChild),
